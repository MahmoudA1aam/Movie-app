...
import '../../business_logic_layer/watch_list_bloc/watch_list_cubit.dart';
...
class _WatchListViewState extends State<WatchListView> {
  ...
  @override
  void initState() {
    watchListCubit = WatchListCubit(watchListServices: WatchListServices());
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              ...
              stream: watchListCubit.getDataRealTimeFromFireStore(),
        ...
        children: [
          Stack(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  await WatchListServices.deleteDataFromFireStore(model);
                },
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
